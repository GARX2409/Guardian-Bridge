  ...
  return (
    <div className="homepage-container">
      ...
      <header className="header">
        <div className="logo">
        <img src="ICONO.png " alt="Puente Guardian" className="logo-img" />
        </div>
        <nav className="nav-links">
          <button onClick={handleAcceso} className="nav-btn">
            Acceder
          </button>
        </nav>
      </header>
      ...
      <section className="info-section">
        <h2 className="info-title">¿Qué ofrece Puente Guardian?</h2>
