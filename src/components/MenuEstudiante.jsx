...
const MenuEstudiante = () => {
  ...
  useEffect(() => {
    ...
    const handleNotification = (newNotification) => {
      // Mostrar alerta si es un cambio en mediación
      if (newNotification.type === "status_changed") {
        alert(`¡Nueva actualización!: ${newNotification.message}`);
      }
  ...
  return (
    <div className="menu-container">
      ...
      <h1 className="menu-title">Bienvenido Estudiante</h1>
      ...
      <div className="menu-buttons">
        ...
        <Link to="/mediacionesestudiante" className="btn btn-warning">
          Mis Mediaciones
        </Link>
